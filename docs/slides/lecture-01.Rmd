...
sustainer propellant. $n = 20$ observations on shear strength (measured in psi) and age (measured in weeks) are availble in the file `rocket.csv`. We'll use these data to fit the SLR model $$Y = \beta_0 + \beta_1 X + \epsilon$$
