...
investr::plotFit(rocket_fit, lwd.fit = 2, 
                 col.fit = "red2", pch = 19)
```
...
# Plot the data with the fitted mean response
investr::plotFit(rocket_fit, lwd.fit = 2, col.fit = "red2", pch = 19)
```
...
.center[.font75[.content-box-yellow[
...
.font200[[Confidence intervals vs prediction intervals](https://stats.stackexchange.com/questions/16493/difference-between-confidence-intervals-and-prediction-intervals)]
...
.font200[.center[.blue[So why even use the coefficient of determination?]]]
...
.font150[.center[.blue[*r* will have the same sign as the estimated slope!]]]
