...
```{r delivery-pairs, fig.width=6, fig.asp=0.618, out.width="90%"}
# Scatterplot matrix
pairs(delivery, pch = 19, col = adjustcolor("purple", alpha.f = 0.6))
```
...
```{r delivery-splom, fig.width=6, fig.asp=0.618, out.width="90%"}
