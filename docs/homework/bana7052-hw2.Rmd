...
**Question 2.** Simulation Study (Simple Linear Regression). Assume mean function $E\left(Y|X\right) = 10 + 5 * X$

a. Generate data with $X \sim N\left(\mu = 2, \sigma^2 = 0.12\right)$, sample size $n = 100$, and error term $\epsilon \sim N\left(\mu = 0, \sigma^2 = 0.25\right)$. 
...
b. What do you expect when the sample size $n$ increases? What do you expect when the error variance $\sigma^2$ increases?
