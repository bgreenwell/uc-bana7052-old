...
**Question 34:** (4 pts.) The following regression model is being considered in a water resources study: $$Y_i = \beta_0 + \beta_1 X_{1i} + \beta_2 X_{2i} + \beta_2 X_{1i}X_{2i} + \beta_p \sqrt{X_{3i}} + \epsilon_i$$ State the reduced models for testing whether or not: 
